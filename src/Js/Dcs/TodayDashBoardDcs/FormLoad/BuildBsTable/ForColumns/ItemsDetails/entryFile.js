...
let jVarLocalFormatterFunc = (value, row, index) => {
    return [
        `<a class="like btn btn-success text-white rounded-circle d-flex justify-content-center align-items-center" style="width: 32px; height: 32px;" href="./TodayBranchScanned.html?VoucherRef=${row.pk}" title="Show">`,
